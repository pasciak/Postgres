 ...
 *
 * copy.c
 *		Implements the FDCOPY usd between foreign relations  utility command
 *
...
// accept two relations 


 static CopyState BeginCopyBetween(Relation rel, Node *query, const char *queryString,
  const Oid queryRelId, const char *filename, bool is_program, List *attnamelist, List *options);


static int copyBetween() {
